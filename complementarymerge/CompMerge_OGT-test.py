...
RUN_CONTEXT_NUMBER = 2
SUMMER_OR_FALL = 'F' if RUN_CONTEXT_NUMBER == 3 else 'S'
...
#MERGESPEC_FILE_NAME = os.path.join( UNITTEST_SUBDIR, 'ComplementaryMerge-spec-12SP-flat-20130923.xls' )
...
def main( ):
    ...
    intermediate_path = 'OGT Fall 2012' if ( SUMMER_OR_FALL == 'F' ) else 'OGT Spring 2012'  # Summer has SAS variables.
    pathname = os.path.join(CVSROOT, 'CSSC Score Reporting', intermediate_path, 'Code/Development/Intake')
