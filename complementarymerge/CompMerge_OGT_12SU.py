...
def main( ):
    ...
    """
    run_context = SuiteContext( 'OGT_12SU' )
    log = run_context.get_logger( 'ComplementaryMerge' )
    db_context = run_context.getDBContext( )

    pathname = os.path.join(CVSROOT, 'CSSC Score Reporting', 'OGT Spring 2012', 'Code/Development/Intake')
    ...
    input_table_names = { FLAT_TABLE_KEY_NAME: 'rc1FINAL', 'C': 'mc_table_C', 'M': 'mc_table_M', 'R': 'mc_table_R',
        'S': 'mc_table_S', 'W': 'mc_table_W' }
    output_table_names = { FLAT_TABLE_KEY_NAME: 'rc1FINAL_cmrg', 'C': 'mc_table_C_cmrg', 'M': 'mc_table_M_cmrg',
