...
class SasMerge( object ):
    ...
    def _get_column_names(self):
        ...
        self.table1_columns = ['TB1.' + each[0].encode('ascii').upper() for each in self.table1_columns_results]
        self.table1_columns_nulls = [ 'null as ' + each[0].encode('ascii').upper() for each in self.table1_columns_results]
        ...
        self.table2_columns = ['TB2.' + each[0].encode('ascii').upper() for each in self.table2_columns_results]
        self.table2_columns_nulls = ['null as ' + each[0].encode('ascii').upper() for each in self.table2_columns_results]
    ...
    def _insert_left_join(self):
        ...
        """This query is for all unique rows in TABLE-1"""
    ...
    def _insert_right_join(self):
        """This query if for all unique rows in TABLE-2"""
...
if __name__ == '__main__':
    ...
    sm = SasMerge(dbcontext = dbcontext,runcontext = runcontext, merge_table_1 = "Employee_merge_1" , merge_table_2 = "Employee_merge_2", mergeids = ["Emp_Num"], drop_columns = [],
                  keep_columns = ['EMP_AGE'] ,output_table = "Merge_Output_table")
    sm.process()          